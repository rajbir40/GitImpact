      ...
      <div className="grid md:grid-cols-3 items-center shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-xl overflow-hidden">
        ...
        <div className="max-md:order-1 flex flex-col justify-center md:space-y-16 space-y-8 max-md:mt-16 min-h-full bg-gradient-to-r from-gray-900 to-gray-700 lg:px-8 px-4 py-4">
          <div>
            ...
            <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">
              Access your account and manage your tasks efficiently.
            </p>
          </div>
          <div>
            <h4 className="text-white text-lg">Secure Login</h4>
            <p className="text-[13px] text-gray-300 mt-3 leading-relaxed">
              Your credentials are safe with our industry-standard security measures.
            </p>
          </div>
        </div>
        ...
        <form className="md:col-span-2 w-full py-6 px-6 sm:px-16 max-md:max-w-xl mx-auto">
          ...
          <div className="space-y-6">
            {/* Email Input */}
            <div>
              <label className="text-gray-600 text-sm mb-2 block" style={{ color: "#1D3557" }}>
                Email address
              </label>
